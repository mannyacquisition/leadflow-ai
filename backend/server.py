...
from routes import auth_router, signals_router, webhook_router, leads_router, ai_router, admin_router, rag_router, orchestration_router, hub_router, monara_router
...
app.include_router(monara_router, prefix="/api")
